...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const initScripts = async () => {
      if (!document.querySelector('script[src="/engine.js?v=3"]')) {
        await loadScript('/engine.js?v=3');
      }
      ...
      for (const mod of modules) {
        if (!document.querySelector(`script[src="/modules/${mod}.js?v=3"]`)) {
          await loadScript(`/modules/${mod}.js?v=3`);
        }
      }

      if (!document.querySelector('script[src="/app.js?v=3"]')) {
        await loadScript('/app.js?v=3');
      }
  ...
  <div class=\"sidebar-bottom\">
    ...
    <section class="view" id="view-inventory" aria-label="Estoque Inteligente">
      <div class="page-header">
        ...
        <div class="page-header-actions">
          <button class="btn-primary" onclick="openModalEl('invModal')">+ Novo Produto</button>
        </div>
      </div>
